...
(function () {
  ...
  var INGREDIENTS = {
    ...
    VE: { nick: '든든한 비타민E',        icon: '🌻' },
    CE: { nick: '철벽보호 세라마이드',   icon: '🛡️' },
    CI: { nick: '진정천재 시카',         icon: '🌿' },
  };
  ...
  var ingredientData = {
    ...
    'VC+VE': {
      grade:   'great',
      badge:   '🤝 영혼의 단짝 조합',
      title:   '까칠한 비타민C + 든든한 비타민E',
      summary: '서로의 부족함을 완벽히 채워주는, 전설의 \'운명적 재회\' 커플입니다!',
      principle: '비타민 C는 열정적이지만 쉽게 지치는 성격(산화되기 쉬움)인 반면, 비타민 E는 묵묵히 뒤를 받쳐주는 든든한 조력자 스타일입니다. 비타민 C가 자외선이나 외부 자극과 싸우다 지쳐서 에너지를 다 써버리면(산화되면), 옆에 있던 비타민 E가 자신의 에너지를 나눠주어 비타민 C를 다시 활성화(환원)시켜 줍니다. 이 환상적인 호흡 덕분에 두 성분이 함께 있으면 항산화 효과가 혼자일 때보다 몇 배나 강력해집니다.',
      skinEffect: '비타민 C는 수용성이라 피부 겉과 수분막에서 작용하고, 비타민 E는 지용성이라 피부의 유분막과 장벽 깊숙이 침투합니다. 즉, 피부의 수성 영역과 유성 영역 모두를 촘촘하게 방어하게 되는 것이죠. 이는 광노화(햇빛에 의한 노화)를 막고 피부 탄력을 유지하는 데 최적의 환경을 만들어줍니다.',
      prescription: [
        { time: '아침', desc: '아침 스킨케어 때 두 성분을 함께 바르고 선크림을 얹어주면 그날 하루 피부는 철갑을 두른 듯 안전할 거예요.' },
        { time: '팁',   desc: '시중에 "CE 페룰릭"처럼 함께 배합된 제품이 많은 이유도 바로 이 강력한 시너지 때문입니다.' },
      ],
    },
    ...
    'NA+RT': {
      grade:   'great',
      badge:   '✨ 완벽한 보완 조합',
      title:   '만능 나이아신아마이드 + 밤의 레티놀',
      summary: '불같은 성격의 레티놀을 따뜻하게 감싸안는 나이아신아마이드의 포용력!',
      principle: '레티놀은 피부 세포를 빠르게 재생시키는 능력이 탁월하지만, 처음 만나는 사람에게는 붉은기나 따가움을 선물하는 아주 \'까칠한\' 성격입니다. 반면 나이아신아마이드는 피부 장벽을 탄탄하게 다지고 염증을 가라앉히는 \'평화주의자\'입니다. 레티놀이 피부에서 소란을 피우려고 할 때, 나이아신아마이드가 미리 장벽을 세워 진정시켜 주므로 부작용 없이 레티놀의 장점만 쏙쏙 뽑아먹을 수 있게 도와줍니다.',
      skinEffect: '레티놀의 치명적인 단점인 \'레티놀 번(피부 화끈거림)\'이나 건조함을 나이아신아마이드의 세라마이드 합성 능력이 보완해줍니다. 결과적으로 모공은 조여주고 주름은 펴주면서도 피부는 편안한 상태를 유지하게 됩니다.',
      prescription: [
        { time: '저녁', desc: '나이아신아마이드 세럼을 먼저 발라 피부 보호막을 친 뒤, 레티놀 제품을 소량 바르는 방식을 추천합니다.' },
        { time: '팁',   desc: '레티놀 입문자라면 반드시 나이아신아마이드를 곁에 두세요. 밤 사이 최고의 재생 효율을 발휘하는 나이트 루틴의 필살기입니다.' },
      ],
    },
    ...
    'CE+RT': {
      grade:   'great',
      badge:   '🛡️ 장벽 보호 시너지',
      title:   '철벽보호 세라마이드 + 밤의 레티놀',
      summary: '까칠한 완벽주의자 레티놀을 묵묵히 보좌하는 든든한 보디가드!',
      principle: '레티놀은 피부 세포를 빠르게 회전시키는 과정에서 필연적으로 피부 장벽을 흔들고 예민하게 만듭니다. 이때 세라마이드가 등장하면 상황이 달라집니다. 세라마이드는 피부 세포 사이사이를 메워주는 \'시멘트\' 같은 역할을 하여, 레티놀이 열심히 공사를 진행하는 동안 담벼락이 무너지지 않도록 꽉 잡아줍니다. 둘의 만남은 피부에 긴장감과 안정감을 동시에 부여하는 환상의 호흡이라 할 수 있습니다.',
      skinEffect: '레티놀 사용 시 흔히 겪는 각질 일어남이나 붉은기를 세라마이드가 즉각적으로 보완합니다. 피부의 지질 구조를 튼튼하게 유지하면서 레티놀의 안티에이징 효과를 누릴 수 있게 해주므로, 민감성 피부도 안심하고 고기능성 케어를 시작할 수 있는 환경을 조성합니다.',
      prescription: [
        { time: '저녁', desc: '레티놀 제품을 바른 직후, 세라마이드가 듬뿍 함유된 보습 크림을 덧발라주세요.' },
        { time: '팁',   desc: '세라마이드가 레티놀의 자극을 \'쿠션\'처럼 흡수해 줄 거예요. 건조한 날에는 이 조합이 피부를 구원할 최후의 보루입니다.' },
      ],
    },
    ...
    'CI+VC': {
      grade:   'great',
      badge:   '🌿 안심 화이트닝 조합',
      title:   '진정천재 시카 + 까칠한 비타민C',
      summary: '비타민C의 뜨거운 열정을 시카의 차분함으로 식혀주는 쿨한 만남!',
      principle: '비타민C는 피부를 환하게 밝혀주지만, 특유의 산성(Acid) 성질 때문에 바르는 즉시 따끔거리는 \'화끈한\' 신고식을 치르곤 합니다. 여기서 시카(병풀 추출물)가 등판하면 이야기가 달라집니다. 시카는 외부 자극에 화가 난 피부 세포를 빠르게 진정시키고 염증을 억제하는 \'평화 유지군\' 역할을 수행합니다. 비타민C가 멜라닌과 싸우는 동안, 시카는 그 과정에서 발생하는 피부의 피로도를 낮춰줍니다.',
      skinEffect: '비타민C가 항산화 작용을 하는 동안 시카는 피부 재생을 도와 장벽의 회복 탄력성을 높여줍니다. 특히 자외선에 노출되어 열감이 오른 피부에 비타민C의 미백 효과와 시카의 쿨링 진정 효과가 만나면, 색소 침착 예방과 피부 온도 조절이라는 두 마리 토끼를 동시에 잡을 수 있습니다.',
      prescription: [
        { time: '아침', desc: '비타민C 세럼을 바른 뒤, 시카 성분이 들어간 마스크팩이나 젤 크림으로 마무리해 보세요.' },
        { time: '팁',   desc: '비타민C의 따끔거림은 사라지고 맑은 광채만 남게 될 거예요. 예민한 피부를 위한 \'안심 화이트닝\' 정석입니다.' },
      ],
    },
